...
3. 現在開いているすべてのウインドウが **アプリケーションアイコン** と共に **[アプリ名] ウインドウタイトル** の形式で一覧表示されます。長いタイトルはメニューを見やすく保つために自動的に省略されます。
4. 同じアプリケーションのウインドウが **3つ以上** ある場合、アプリ名の下に自動的にグループ化されます（例: **「Safari (4)」**）。アプリにカーソルを合わせて個別のウインドウを表示し、さらにウインドウにカーソルを合わせるとサイズが表示されます。
5. ウインドウにカーソルを合わせると、利用可能なプリセットサイズが表示されます。
6. サイズをクリックすると、ウインドウが即座にリサイズされます。
...
以下の機能はウインドウ操作のアクセシビリティを向上させます。いずれかの機能が有効な場合、リサイズメニューの先頭に **「現在のサイズ」** オプションが表示され、サイズを変更せずにウインドウの位置変更や前面への移動が行えます。

### ウインドウを前面に移動

**「リサイズ後にウインドウを前面に移動」** をオンにすると、リサイズ後にウインドウが自動的に他のウインドウの手前に表示されます。対象のウインドウが他のウインドウに隠れている場合に便利です。

### メインスクリーンに移動

**「メインスクリーンに移動」** をオンにすると、リサイズ時にウインドウをメインディスプレイに移動します。マルチモニター環境で、セカンダリディスプレイからウインドウを素早く移動したい場合に便利です。

### ウインドウの配置位置

リサイズ後にウインドウを画面上のどこに配置するかを選択します。9つのボタンが配置オプションを表します。

- **四隅:** 左上、右上、左下、右下
- **辺の中央:** 上中央、左中央、右中央、下中央
- **中央:** 画面の中央

ボタンをクリックして選択します。同じボタンをもう一度クリックするか、**「位置変更なし」** をクリックして選択を解除します。位置が選択されていない場合、リサイズ後もウインドウは元の位置のまま残ります。

> **注意:** ウインドウの配置はメニューバーと Dock を考慮し、使用可能な画面領域内に収まるよう調整されます。
...
- **ファイルに保存** — スクリーンショットを PNG ファイルとして保存します。**「選択...」** をクリックして保存先フォルダを選択します。
  > **ファイル名の形式:** `MMddHHmmss_アプリ名_ウインドウタイトル.png`（例: `0227193012_Safari_Apple.png`）。記号は除去され、英数字とアンダースコアのみ使用されます。
